...
package com.blackshark.flutterblue;
...
import com.blackshark.flutterblue.reflect.MethodUtils;
...
public class FlutterBluePlugin implements MethodCallHandler, RequestPermissionsResultListener  {
    ...
    private final EventChannel deviceChannel;
    ...
    FlutterBluePlugin(Registrar r){
        ...
        this.deviceChannel = new EventChannel(registrar.messenger(), NAMESPACE+"/device");
